...
let monkey = new Sound("assets/sounds/monkeyCry.mp3", 4300, "#monkeyButton", "assets/icons/monkey.png", "#monkeyZone" ); 
// let monkey = new Sound("assets/sounds/monkeyCry.mp3", 4300, "#monkeyButton");
let bird = new Sound("assets/sounds/birds.mp3", 4552, "#birdButton", "assets/icons/bird.png", "#birdZone");
